...
# -*- coding: utf-8 -*-
#
# Optimizing for CUDA's Architecture documentation build configuration file, created by
...
htmlhelp_basename = 'OptimizingforCUDAsArchitecturedoc'
...
man_pages = [
('index', 'Optimizing for CUDA Architecture', u'Optimizing for CUDA Architecture',
...
texinfo_documents = [
('index', 'Optimizing for CUDA Architecture', u'Optimizing for CUDA Architecture',
u'CSInParallel Project', 'Optimizing for CUDA Architecture', 'A demonstration of CUDA Architectue using a Mandelbrot set generator',
'Miscellaneous'),
]
