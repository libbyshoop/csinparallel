...
html_title = 'Timing CUDA Operations'
...
man_pages = [
('index', 'CudaVectorAdd', u'CudaVectorAdd',
...
texinfo_documents = [
('index', 'CudaVectorAdd', u'CudaVectorAdd',
u'CSInParallel Project', 'CudaVectorAdd', 'Teach students the basics of CUDA programming and the tradeoffs of GPU computing',
'Miscellaneous'),
]
