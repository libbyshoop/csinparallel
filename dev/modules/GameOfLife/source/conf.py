...
# sphinx-quickstart on Mon Aug  5 10:38:22 2013.
#
...
latex_documents = [
  ('index', 'GameOfLife.tex', u'Game Of Life',
   u'CsInParallrl Project', 'manual'),
]
...
man_pages = [
    ('index', 'gameoflife', u'Game Of Life',
     [u'CsInParallrl Project'], 1)
]
...
texinfo_documents = [
  ('index', 'GameOfLife', u'Game Of Life',
   u'CsInParallrl Project', 'GameOfLife', 'One line description of project.',
   'Miscellaneous'),
]
