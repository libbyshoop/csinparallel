...
For of the each process's people, this function spawns threads to move them around randomly.
...
For of the each process's people, this function spawns threads to handle those that are ssusceptible by deciding whether or not they should be marked infected.
...
For of the each process's people, this function spawns threads to handle those that are infected by deciding whether they should be marked immune or dead.
...
For of the each process's people, this function spawns threads to handle those that are infected by increasing the number of days infected.
