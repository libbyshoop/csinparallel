# -*- coding: utf-8 -*-
#
# Finding the Area Under the Curve documentation build configuration file, created by
# sphinx-quickstart on Fri Jul 26 09:40:22 2013.
#
...
project = u'Finding the Area Under the Curve'
...
html_title = 'Finding the Area Under the Curve'
...
htmlhelp_basename = 'FindingtheAreaUndertheCurvedoc'
...
latex_documents = [
  ('index', 'FindingtheAreaUndertheCurve.tex', u'Finding the Area Under the Curve',
...
man_pages = [
    ('index', 'findingtheareaunderthecurve', u'Finding the Area Under the Curve',
...
texinfo_documents = [
  ('index', 'FindingtheAreaUndertheCurve', u'Finding the Area Under the Curve',
   u'CSInParallel Project', 'FindingtheAreaUndertheCurve', 'One line description of project.',
   'Miscellaneous'),
]
