...
# -*- coding: utf-8 -*-
#
# Hadoop Network Analysis documentation build configuration file, created by
...
project = 'Hadoop Network Analysis'
...
html_title = 'Hadoop Network Analysis'
...
htmlhelp_basename = 'HadoopNetworkAnalysisdoc'
...
latex_documents = [
('index', 'HadoopNetworkAnalysis.tex', u'Hadoop Network Analysis',
...
man_pages = [
('index', 'Hadoop Network Analysis', u'Hadoop Network Analysis',
...
texinfo_documents = [
('index', 'Hadoop Network Analysis', u'Hadoop Network Analysis',
u'CSInParallel Project', 'Hadoop Network Analysis', 'Analyze Flickster friend data with hadoop',
'Miscellaneous'),
]
