# -*- coding: utf-8 -*-
#
# Parallel Patternlets documentation build configuration file, created by
...
project = u'Building a Raspberry Pi Cluster'
...
html_title = 'Building a Raspberry Pi Cluster'
...
htmlhelp_basename = 'BuildingARaspberryPiClusterdoc'
...
latex_documents = [
  ('index', 'RPiCluster.tex', u'Building a Raspberry Pi Cluster',
...
man_pages = [
    ('index', 'Building a Raspberry Pi Cluster', u'Building a Raspberry Pi Cluster',
...
texinfo_documents = [
  ('index', 'Building a Raspberry Pi Cluster', u'Building a Raspberry Pi Cluster',
   u'CSinParallel Project', 'Building a Raspberry Pi Cluster', 'How to Build a Raspberry pi Cluster.',
   'Miscellaneous'),
]
