# -*- coding: utf-8 -*-
#
# Concurrent Data Structures in C++ documentation build configuration file, created by
...
project = u'Concurrent Data Structures in C++'
...
# The language for content autogenerated by Sphinx. Refer to documentation'releasename': '', 'classoptions': ',openany,oneside', 'babel' : '\\usepackage[english]{babel}'
...
html_title = 'Concurrent Data Structures in C++'
...
htmlhelp_basename = 'ConcurrentDataStructuresinCdoc'
