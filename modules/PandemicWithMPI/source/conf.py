# -*- coding: utf-8 -*-
#
# Pandemic with MPI documentation build configuration file, created by
...
htmlhelp_basename = 'PandemicwithMPIdoc'
...
latex_documents = [
  ('index', 'PandemicwithMPI.tex', u'Pandemic with MPI',
...
man_pages = [
    ('index', 'pandemicwithmpi', u'Pandemic with MPI',
...
texinfo_documents = [
  ('index', 'PandemicwithMPI', u'Pandemic with MPI',
   u'CSInParallel Project', 'PandemicwithMPI', 'One line description of project.',
   'Miscellaneous'),
]
