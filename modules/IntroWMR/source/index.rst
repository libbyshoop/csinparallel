.. Map-reduce Computing for Introductory Students using WebMapReduce documentation master file, created by
   sphinx-quickstart on Thu Jul 19 16:25:03 2012.
...
The next section, *Using WebMapReduce (WMR)*, walks you through a simple, basic example of
counting words in text files.  The third section, entitled 
*Counting words with WebMapReduce (WMR): adding efficiency*, shows a slightly revised version
...
.. toctree::
   ...
   MapReduceIntro/MapReduceIntro
   wmr_basic/wmr_multi_language
   wmr_py/wmr_py
   WmrActivities/WmrActivities
