# -*- coding: utf-8 -*-
#
# Try_yuan documentation build configuration file, created by
# sphinx-quickstart on Thu May 30 11:49:23 2013.
#
...
if 'Darwin' in platform.uname()[0]:
        ...
        pngmath_latex = 'Program Files (x86)/MiKTeX 2.8/miktex/latex'
        pngmath_dvipng = 'Program Files (x86)/MiKTeX 2.8/miktex/dvipng'
...
latex_documents = [
  ('index', 'Try_yuan.tex', u'Try\\_yuan',
...
texinfo_documents = [
  ('index', 'Try_yuan', u'Try_yuan',
   u'CSInParallel Project', 'Try_yuan', 'One line description of project.',
   'Miscellaneous'),
]
