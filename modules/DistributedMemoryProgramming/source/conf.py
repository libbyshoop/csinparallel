# -*- coding: utf-8 -*-
#
# MPI and Hybrid MPI_CUDA documentation build configuration file, created by
...
project = u'Distributed Computing Fundamentals'
...
html_title = 'Distributed Computing Fundamentals'
...
htmlhelp_basename = 'DistributedComputingFundamentals'
...
latex_documents = [
  ('index', 'DistributedComputingFundamentals.tex', u'Distributed Computing Fundamentals',
...
man_pages = [
    ('index', 'distributedcomputingfundamentals', u'Distributed Computing Fundamentals',
...
texinfo_documents = [
  ('index', 'DistributedComputingFundamentals', u'Distributed Computing Fundamentals',
   u'CSInParallel Project', 'DistributedComputingFundamentals', 'One line description of project.',
   'Miscellaneous'),
]
