# -*- coding: utf-8 -*-
#
# Concept: The Data Decomposition Pattern documentation build configuration file, created by
...
project = u'Concept: The Data Decomposition Pattern'
...
html_title = 'Concept: The Data Decomposition Pattern'
...
htmlhelp_basename = 'ConceptTheDataDecompositionPatterndoc'
...
latex_documents = [
('index', 'ConceptTheDataDecompositionPattern.tex', u'Concept: The Data Decomposition Pattern',
...
man_pages = [
('index', 'Concept: The Data Decomposition Pattern', u'Concept: The Data Decomposition Pattern',
...
texinfo_documents = [
('index', 'Concept: The Data Decomposition Pattern', u'Concept: The Data Decomposition Pattern',
u'CSInParallel Project', 'Concept: The Data Decomposition Pattern', 'A brief reading to introduce the classic data decomposition pattern in parallel programming.',
'Miscellaneous'),
]
